 ...
 */
class Stage extends \Application\Model\Stage implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'name', 'sequence', 'notes', 'creationDate', 'lastUpdateDate', 'opportunities');
    }
